...
// This screen appears to be a duplicate or slightly varied version of the Unloading Tally in the list.
// We'll create a generic similar layout based on previous Unloading screens as there was no specific 15th image.
const IFXUnloadingTally = ({ navigation }) => {
  return (
    <SafeAreaView style={styles.safeArea}>
      <Header 
        title="IFX+IWL Unloading Tally" 
...
export default IFXUnloadingTally;
